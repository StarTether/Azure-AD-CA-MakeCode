var pxtTargetBundle = {
  "id": "camakecode",
  "name": "CaMakeCode",
  "title": "MakeCode Editor for Microsoft Conditional Access Policies",
  "corepkg": "core",
  "cloud": {
    "workspace": false,
    "packages": true
  ...
  "appTheme": {
    ...
    "docMenu": [
      {
        "name": "About",
        "path": "/Azure-AD-CA-MakeCode/docs/about"
      },
      {
        "name": "Docs",
        "path": "/Azure-AD-CA-MakeCode/docs/docs"
      }
    ],
  ...
  "bundledpkgs": {
    "core": {
      ...
      "pxt.json": "{\n    \"name\": \"core\",\n    \"description\": \"A target file for PXT for Azure AD Conditional Access Policies\",\n    \"files\": [\n        \"README.md\",\n        \"pxt-core.d.ts\",\n        \"pxt-helpers.ts\",\n        \"ns.ts\"\n    ],\n    \"testFiles\": [\n        \"test.ts\"\n    ],\n    \"public\": true,\n    \"dependencies\": {},\n    \"targetVersions\": {\n        \"target\": \"2.0.2\"\n    }\n}",
      "test.ts": ""
    }
  },
  "compile": {
